      ...
      <div className="row align-items-center">
        ...
        <div className="col-lg-6">
          <div className="why-choose-two__top__right wow fadeInUp" data-wow-delay="900ms">
            <p className="about-two__top__text">There are many variations of passages of Lorem Ipsum avalable, but the majority have suffered choose eration in some form, by injected humour, or randomised words which don&apos;t look even slightly believable. </p>
          </div>
        </div>
      </div>
      <div className="row">
        <div className="col-lg-6">
          <div className="why-choose-two__inner__left">
